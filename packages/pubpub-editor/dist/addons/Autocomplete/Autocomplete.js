...
var Autocomplete = exports.Autocomplete = _react2.default.createClass({
	...
	propTypes: {
		...
		globalCategories: _react.PropTypes.array, // ['pubs', 'users']
	...
	updateMentions: function updateMentions(mentionInput) {
		...
		if (mentionInput) {
			setTimeout(function () {
				...
				if (mentionInput !== _this3.state.input) {
					_this3.getNewSelections(mentionInput);
				}
				_this3.setState({
					visible: true,
					top: top,
	...
	render: function render() {
		...
		var noResultsNoInput = !results.length && (input === '' || input === ' ') && !!this.state._suggestionCategory;
		...
		return _react2.default.createElement(
			'div',
			{ className: 'pt-card pt-elevation-4', style: styles.container(top, left, visible) },
			results.map(function (result, index) {
				...
				return _react2.default.createElement(
					'div',
					{ key: 'result-' + result.itemType + '-' + result.id, style: styles.resultWrapper(_this4.state._selectedIndex === index, isCategory), onMouseEnter: _this4.setCurrentIndex.bind(_this4, index), onClick: _this4.selectResult.bind(_this4, index) },
