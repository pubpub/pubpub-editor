...
var CollaborativeAddon = exports.CollaborativeAddon = _react2.default.createClass({
	...
	statics: {
		getPlugins: function getPlugins(_ref) {
			...
			return [(0, _FirebasePlugin2.default)({ selfClientID: selfClientID, editorKey: editorKey, firebaseConfig: firebaseConfig, pluginKey: firebaseKey }), (0, _prosemirrorCollab.collab)({ clientID: selfClientID })];
		}
	},
