...
function pagebreak(state, startLine, endLine, silent) {
	...
	if (state.src.charAt(pos++) !== 'p') {
		return false;
	}
	if (state.src.charAt(pos++) !== 'a') {
		return false;
	}
	if (state.src.charAt(pos++) !== 'g') {
		return false;
	}
	if (state.src.charAt(pos++) !== 'e') {
		return false;
	}
	if (state.src.charAt(pos++) !== 'b') {
		return false;
	}
	if (state.src.charAt(pos++) !== 'r') {
		return false;
	}
	if (state.src.charAt(pos++) !== 'e') {
		return false;
