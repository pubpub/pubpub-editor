...
var LatexView = function (_ReactView) {
  ...
  _createClass(LatexView, [{
    ...
    value: function changeToBlock() {
      this.changeNode(this.view.state.schema.nodes.block_equation, { content: this.getContent() }, null);
    }
  }, {
    key: 'changeToInline',
    value: function changeToInline() {
      this.changeNode(this.view.stateschema.nodes.equation, { content: this.getContent() }, null);
    }
  }, {
    key: 'selectNode',
