...
var EmbedView = function (_ReactView) {
  ...
  _createClass(EmbedView, [{
    ...
    value: function valueChanged(nodeAttrs) {
      ...
      var nodeType = _setup.schema.nodes.embed;
    ...
    value: function createCaption() {
      ...
      var textnode = _setup.schema.text('Enter caption');
      var captionNode = _setup.schema.nodes.caption.create({}, textnode);
    ...
    value: function updateCaption(txt) {
      ...
      var slice = new _prosemirrorModel.Slice(_prosemirrorModel.Fragment.from(_setup.schema.text(txt)), 0, 0);
