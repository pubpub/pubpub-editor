...
var EmbedView = function (_ReactView) {
  ...
  _createClass(EmbedView, [{
    ...
    value: function createCaption() {
      ...
      var captionNode = _schema.schema.nodes.caption.create({}, textnode);
    ...
    value: function updateCaption(txt) {
      ...
      var slice = new _prosemirrorModel.Slice(_prosemirrorModel.Fragment.from(_schema.schema.text(txt)), 0, 0);
