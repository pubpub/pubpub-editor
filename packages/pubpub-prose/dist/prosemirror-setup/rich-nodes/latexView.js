...
var LatexView = function (_ReactView) {
  ...
  _createClass(LatexView, [{
    ...
    value: function changeToBlock() {
      this.changeNode(_schema.schema.nodes.block_equation, { content: this.getContent() }, null);
    }
  }, {
    key: 'changeToInline',
    value: function changeToInline() {
      this.changeNode(_schema.schema.nodes.equation, { content: this.getContent() }, null);
    }
  }, {
    key: 'selectNode',
