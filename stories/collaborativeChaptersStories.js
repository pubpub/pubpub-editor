...
let editorRef;
const onClickFunc = ()=> {
	editorRef.getCollabJSONs(['storybook-editor-v22/', 'storybook-editor-v22/chapter1'])
	.then((vals)=> {
		console.log(vals);
	});
};

storiesOf('CollaborativeChapters', module)
.add('default', () => (
	<div>
		<div style={editorWrapperStyle}>
			<Editor ref={(ref)=> { editorRef = ref; }} editorId={'editor'} placeholder="type here">
				<FormattingMenu />
				<InsertMenu />
				...
				<Collaborative
					...
					editorKey={'storybook-editor-v22/chapter1'}
				/>
			</Editor>
		</div>
		<button className="pt-button" onClick={onClickFunc}>Click Me</button>
	</div>
));
